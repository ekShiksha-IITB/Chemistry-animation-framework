...
public class DisReaction {
    ...
    public void setAll(int id,int n1,int n2,int p1,int p2, String reactant1,String reactant2,String product1, String product2,String reaction)
    {
        this.id=id;
        this.n1=n1;
        this.n2=n2;
