 ...
 * @author aishwarya
 */
public class DDisInputServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int status=disreactionDAO.addDReaction(reactant_1,n1,reactant_2,n2,product_1,p1,product_2,p2,reaction);
        ...
        request.getRequestDispatcher("index.jsp?option=8").forward(request, response);
                ...
                response.sendRedirect("index.jsp?option=8");
