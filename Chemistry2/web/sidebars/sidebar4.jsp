...
<!DOCTYPE html>
<input type="image" class="plus" onclick="openModal('id02')" src="Images/plus.png" alt="Submit" width="40px" height="40px">
        ...
        <label style="font-size: 14px">Crystal Structures<br></label>
            ...
            %>
                    ...
                    <li id="lattice<%= lattices.get(i).getId()%>" class="hintLeft lattices" onclick="setShape('<%= lattices.get(i).getId()%>','<%= lattices.get(i).getSideConstraint()%>','<%=lattices.get(i).getAngleConstraint() %>')" style="cursor:pointer"><%= lattices.get(i).getName()%>
                    </li><br>
