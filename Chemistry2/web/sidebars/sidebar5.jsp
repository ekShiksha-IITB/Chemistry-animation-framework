...
<input type="image" class="plus" onclick="openModal('id03')" src="Images/plus.png" alt="Submit" width="40px" height="40px">
...
<center><br>
            ...
            ResultSet myRs=statement.executeQuery("select distinct reactant_1 from combination_reaction");
            while(myRs.next())
            {
            %>     
        ...
        <datalist  id="reactant_2">
            ...
            Connection connection = ConnectionFactory.getConnection();
            Statement statement = connection.createStatement();
            ResultSet myRs=statement.executeQuery("select distinct reactant_2 from combination_reaction");
            while(myRs.next())
            {
            %>     
