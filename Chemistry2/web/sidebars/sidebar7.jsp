...
<input type="image" class="plus" onclick="openModal('id05')" src="Images/plus.png" alt="Submit" width="40px" height="40px">
                             
<label style="cursor:pointer" >Single Displacement reactions <i onclick="callReactionsDemo(3)" class="glyphicon glyphicon-play-circle"></i><br><br></label>
