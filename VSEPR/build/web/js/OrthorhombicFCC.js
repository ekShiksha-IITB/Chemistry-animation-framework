function OrthorhombicFCC(r) {
	...
	s1.position.set(-1.5*r, -1.1*r, r) ;
	shape.add(s1) ;
	var s2 = new THREE.Mesh(
		new THREE.SphereBufferGeometry(0.3, 32, 32),
		new THREE.MeshBasicMaterial({color : 'steelblue'})
	);
	s2.position.set(+1.5*r, -1.1*r, r) ;
	shape.add(s2) ;
	var s3 = new THREE.Mesh(
		new THREE.SphereBufferGeometry(0.3, 32, 32),
		new THREE.MeshBasicMaterial({color : 'steelblue'})
	);
	s3.position.set(+1.5*r, +1.1*r, r) ;
	shape.add(s3) ;
	var s4 = new THREE.Mesh(
		new THREE.SphereBufferGeometry(0.3, 32, 32),
		new THREE.MeshBasicMaterial({color : 'steelblue'})
	);
	s4.position.set(-1.5*r, +1.1*r, r) ;
	shape.add(s4) ;
	...
	s5.position.set(-1.5*r, -1.1*r, -r) ;
	shape.add(s5) ;
	var s6 = new THREE.Mesh(
		new THREE.SphereBufferGeometry(0.3, 32, 32),
		new THREE.MeshBasicMaterial({color : 'steelblue'})
	);
	s6.position.set(+1.5*r, -1.1*r, -r) ;
	shape.add(s6) ;
	var s3 = new THREE.Mesh(
		new THREE.SphereBufferGeometry(0.3, 32, 32),
		new THREE.MeshBasicMaterial({color : 'steelblue'})
