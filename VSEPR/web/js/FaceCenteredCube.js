function FaceCenteredCube(r) {
	...
	s1.position.set(-r, -r, r) ;
	shape.add(s1) ;
	var s2 = new THREE.Mesh(
		new THREE.SphereBufferGeometry(0.3, 32, 32),
		new THREE.MeshBasicMaterial({color : 'steelblue'})
	);
	s2.position.set(+r, -r, r) ;
	shape.add(s2) ;
	var s3 = new THREE.Mesh(
		new THREE.SphereBufferGeometry(0.3, 32, 32),
		new THREE.MeshBasicMaterial({color : 'steelblue'})
	);
	s3.position.set(+r, +r, r) ;
	shape.add(s3) ;
	var s4 = new THREE.Mesh(
		new THREE.SphereBufferGeometry(0.3, 32, 32),
		new THREE.MeshBasicMaterial({color : 'steelblue'})
	);
	s4.position.set(-r, +r, r) ;
	shape.add(s4) ;
    ...
    l6.vertices.push(new THREE.Vector3(-r, +r, -r)) ;
    l6.vertices.push(new THREE.Vector3(-r, -r, -r)) ;
